...
// ---------- product definition ----------
const CODE = 'A171';
const TITLE = `${CODE} – Reem Bisht & Pants 2-Piece Set`;
const TITLE_AR = `${CODE} – طقم ريم بشت وبنطلون (قطعتين)`;
const PRICE = '25.000';
...
const BODY_HTML =
  '<p>The Reem two-piece set pairs a softly draping open bisht with matching wide-leg trousers, both in a warm beige block print with a geometric diamond motif in black and terracotta.</p>' +
  '<p>Contrasting patchwork panels on the wide kimono sleeves and a gold satin border down the front add an artisanal, considered finish. Cut from lightweight, breathable cotton that stays cool and easy.</p>' +
...
const BODY_HTML_AR =
  '<p>طقم ريم المكوّن من قطعتين يجمع بين بشت مفتوح بانسدالٍ ناعم وبنطلون واسع منسّق، كلاهما بنقشةٍ مطبوعة بلون البيج الدافئ بزخارف هندسية معيّنة باللونين الأسود والطوبي.</p>' +
  '<p>تضيف الألواح المتباينة على الأكمام الواسعة وحاشية الساتان الذهبية في المقدّمة لمسةً حرفية مدروسة. مصنوع من قطن خفيف ومسامي يمنحكِ إحساساً منعشاً ومريحاً.</p>' +
...
const TAGS = [
  ...
  'printed', 'patterned', 'block-print', 'geometric', 'beige', 'cream', 'ivory', 'black', 'terracotta', 'gold',
  'gulf', 'heritage', 'khaleeji', 'kuwait', 'luxury', 'set', 'casual', 'daytime',
  'بشت', 'بنطلون', 'طقم', 'طقم-بشت', 'قطعتين', 'قطن', 'صيفي', 'خفيف', 'بيج', 'كريمي', 'أسود', 'هندسي',
  'مطبوع', 'منقوش', 'خليجي', 'الكويت', 'فاخر', 'واسع',
].join(', ');

const SEO_TITLE = 'Reem Cotton Bisht & Pants Set – Beige Geometric Block Print | Atelier Blue Marine';
const SEO_DESC = 'Lightweight cotton 2-piece set: open bisht + wide-leg pants in a beige geometric block print with gold trim. Breathable summer wear, sizes XS–3XL. Atelier Blue Marine, Kuwait.';
const SEO_TITLE_AR = 'طقم ريم بشت وبنطلون قطني – بيج بنقشة هندسية | أتيليه بلو مارين';
const SEO_DESC_AR = 'طقم من قطعتين من القطن الخفيف: بشت مفتوح وبنطلون واسع بنقشة هندسية بيج مع حاشية ذهبية. مناسب للصيف، مقاسات XS–3XL. أتيليه بلو مارين، الكويت.';
