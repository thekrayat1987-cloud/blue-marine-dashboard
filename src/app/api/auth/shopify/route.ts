...
export async function GET() {
  ...
  const scopes = [
    ...
    "read_validations","write_validations","read_cash_tracking","write_cash_tracking",
    ...
    "write_checkouts","read_checkouts","read_companies","write_companies",
    ...
    "read_customer_payment_methods","read_customer_merge","write_customer_merge",
    ...
    "read_markets","write_markets","read_markets_home","write_markets_home",
    "read_merchant_managed_fulfillment_orders","write_merchant_managed_fulfillment_orders",
    "read_metaobject_definitions","write_metaobject_definitions",
    "read_metaobjects","write_metaobjects",
    "read_online_store_navigation","write_online_store_navigation",
    "read_online_store_pages","write_online_store_pages",
    "write_order_edits","read_order_edits","read_orders","write_orders",
    "write_packing_slip_templates","read_packing_slip_templates",
    "write_payment_mandate","read_payment_mandate",
    ...
    "write_reports","read_reports","read_resource_feedbacks","write_resource_feedbacks",
    "read_returns","write_returns","read_script_tags","write_script_tags",
